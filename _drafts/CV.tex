...
\photo[64pt][0.4pt]{chaordic-profile.jpg}
...
Helped develop a personalized search platform for large Brazilian e-commerce sites.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
...
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Web stack included angularjs, nodejs, amazons3 and mongodb.\end{minipage}
}
...
\section{Education} % =====================================
% \cvitem{2015}{ \textbf{Mobile web development}, \textit{Udacity }}
% \cvitem{}{
% \listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
% Fundamentals for building cross platform optimized mobile web apps.\end{minipage}
% }
% \cvitem{Feb 2015}{ \textbf{Javascript design patterns}, \textit{Udacity }}
% \cvitem{}{
% \listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
% Fundamentals of writing reusable javascript and deep understanding of MVCs.\end{minipage}
% }
...
\cvitem{to current}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Hardware software interface, University of Washington, Coursera.
\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
