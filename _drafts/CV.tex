...
\mobile{0055~48~98387718}
\email{dalberto.adler@gmail.com}
%\homepage{www.davidadler.me}
\extrainfo{\github{
\href{https://www.github.com/mfbx9da4}{github.com/mfbx9da4}
}}
\extrainfo{Dual-nationality: Brazilian-British}
\photo[64pt][0.4pt]{grad3.png}
...
\section{Education} % =====================================
\cvitem{Feb 2015}{ \textbf{Javascript design patterns}, \textit{Udacity }}
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Techniques for writing reusable javascript and deep understanding of MVCs.\end{minipage}
}
\cvitem{May 2013}{ \textbf{Web development course}, \textit{Udacity }}
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Basics of APIs, databases, security and caching.\end{minipage}
}
\cvitem{2009--2013}{ \textbf{2:1 (69\%) BSc Honours Neuroscience}, \textit{University of Manchester }, UK.}
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Averaged 1st in core neuroscience modules.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Demonstrated drive and creativity by designing my own final year project \textit{de novo}.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Project (awarded 1st): Disproved validity of a pioneering artificial intelligence algorithm.
Created my own computational model of learning networks of the brain.
Gained experience in computational modelling and machine learning.\end{minipage}
}
...
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}Featured in the University of Manchester Undergraduate Prospectus.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}Silver Award in UK National Mathematics Challenge.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}Advanced one year for academic attainment in primary school.\end{minipage}
}


\section{Experience} % =====================================

\cvitem{Apr 2014 }{ \textbf{Web developer}, \textit{Chaordic, Florianopolis, Brazil.}}
\cvitem{to Current}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Web stack includes elasticsearch, angularjs, python (Flask), git, docker and nginx.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Principally responsible for javascript code.\end{minipage}
}
...
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Web stack includes angularjs, nodejs, amazons3 and mongodb.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Data visualizations with d3js. \end{minipage}
}


\cvitem{Autumn 2013}{ \textbf{Web developer}, \textit{SuperAwesome, London, UK.}}
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Innovated and developed a front-end automator web app which optimized front-end build time from ~ 5 hours to ~ 1 minute.
Made several presentations on this web app.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Maintained front and backend. Built content management system for website.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Using django, heroku, S3 storage, git, javascript, HTML5 canvas, HTML and CSS.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Developed multiple HTML5 canvas mini-games.\end{minipage}
}


\cvitem{2011--2012}{ \textbf{Neuroscience Research Intern}, \textit{Laboratory of Functional Neuroanatomy, IkerBasque, Spain.}}
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Developed presentation skills in regular boardroom meetings.\end{minipage}
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
Project: Investigated changes in cell morphology of astrocytes in the triple transgenic
mouse model of Alzheimer's disease. Developed skills in data analysis, fluorescence microscopy
and immunohistochemistry.\end{minipage}
}
...
\cvitem{}{
\listitemsymbol\begin{minipage}[t]{\listitemmaincolumnwidth}
I \textbf{love} to code! I have strongest interest in web development but also enjoy AI and solving coding problems.\end{minipage}
...
\hline Python & 4 years experience and favourite language. Developed professionally with django and Flask for websites serving 1000 rpm. Competent with: django, webapp2, Flask, numpy/scipy, pybrain, matplotlib, selenium, BeautifulSoup, elasticsearchpy. & High \\
 Javascript & 4 years experience. Familiar with several MVCs especially angularjs and I have done a course in JS design patterns on udacity. Built several HTML5 canvas games. Also strong experience with nodejs, expressjs, web sockets, mongodb and d3js. Experince with testing using karma, jasmine and phantomJS. & High \\
  C & First language, mostly trivial side projects but a reasonable understanding. & Medium \\
  Java & A few simple android apps. Currently enrolled in a course. & Medium \\
  Go & Small amount of functional programming and experimented with a chat server, but would like to learn more. & Low \\
  CSS & Familiar with SASS, LESS, grunt and building fluid designs. Interested in color systems and typography. & High \\
\end{tabular}\end{minipage}
}

%\section{Interests} % =====================================
%\cvitem{Slacklining}{
%At ground level, I use the slackline as a thin trampoline and have since been sponsored and competed at national level (ranked 4th in the UK). }
%\cvitem{Cycling}{
